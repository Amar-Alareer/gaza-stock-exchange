      ...
      <div class="row g-3 mb-5">
              ...
              <table class="table align-middle text-center table-hover mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="fw-bold">طحين 25 كيلو</td>
                    <td>حي التفاح</td>
                    <td class="text-green fw-bold">السعر شيكل</td>
                    <td>ارخص محل</td>
                    <td>شارع الزكاة</td>
                    <td><span class="map-pin">📍</span></td>
                  </tr>
        ...
        <div class="col-12 col-lg-5">
          <div class="compare-map-wrap rounded-4 overflow-hidden shadow-sm h-100 min-vh-300">
            <img src="imges/map.png" alt="خريطة غزة" class="w-100 h-100 object-fit-cover">
          </div>
        </div>
      </div>
          ...
          <div class="col-12 col-md-4">
            <div class="bg-white rounded-4 p-3 shadow-sm h-100">
              ...
              <div class="price-list small">
                <div class="d-flex justify-content-between py-1 border-bottom"><span>طحين 25 كغ</span><span
                    class="fw-bold text-green">35 ₪</span></div>
                <div class="d-flex justify-content-between py-1 border-bottom"><span>سكر 1 كغ</span><span
                    class="fw-bold text-green">3 ₪</span></div>
                <div class="d-flex justify-content-between py-1 border-bottom"><span>زيت 1 لتر</span><span
                    class="fw-bold text-green">12 ₪</span></div>
                <div class="d-flex justify-content-between py-1 border-bottom"><span>دجاج 1 كغ</span><span
                    class="fw-bold text-green">23 ₪</span></div>
              </div>
            </div>
          </div>

          <!-- Card 2: الأكثر بحثاً اليوم -->
          <div class="col-12 col-md-4">
            <div class="bg-white rounded-4 p-3 shadow-sm h-100">
              <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <div class="col-12 col-md-4">
            <div class="bg-white rounded-4 p-3 shadow-sm h-100">
              ...
              <div class="lowered-list small">
                <div class="d-flex justify-content-between py-1 border-bottom"><span>طحين 25 كغ</span><span
                    class="badge bg-danger-subtle text-danger">↓ 7 ₪</span></div>
                <div class="d-flex justify-content-between py-1 border-bottom"><span>بندورة 1 كغ</span><span
                    class="badge bg-danger-subtle text-danger">↓ 3 ₪</span></div>
                <div class="d-flex justify-content-between py-1 border-bottom"><span>خيار 1 كغ</span><span
                    class="badge bg-danger-subtle text-danger">↓ 2 ₪</span></div>
                <div class="d-flex justify-content-between py-1"><span>دجاج 1 كغ</span><span
                    class="badge bg-danger-subtle text-danger">↓ 3 ₪</span></div>
              </div>
            </div>
          </div>
...
<?php /**PATH C:\xampp\htdocs\gaza-stock-exchange\resources\views/compare.blade.php ENDPATH**/ ?>