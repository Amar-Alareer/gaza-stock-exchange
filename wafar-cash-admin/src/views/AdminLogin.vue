            ...
            <div class="login-card__form">
                ...
                <form @submit.prevent="handleLogin">
                    <label class="field-label" for="username"
                        >اسم المستخدم أو البريد الإلكتروني الإداري</label
                    >
                    <div class="field-input">
                        <span
                            class="field-input__icon"
                    ...
                    >
                        ...
                        <span>{{
                            isLoading ? "جارٍ التحقق..." : "تسجيل دخول كآدمن"
                        }}</span>
                    </button>
                    ...
                    <button type="button" class="btn-google">
                        ...
                        >
                            <path
                                fill="#4285F4"
                                d="M23.49 12.27c0-.83-.07-1.63-.2-2.4H12v4.54h6.44a5.5 5.5 0 0 1-2.39 3.62v3h3.87c2.26-2.08 3.57-5.14 3.57-8.76z"
                            />
                            <path
                                fill="#34A853"
                                d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.87-3c-1.08.72-2.45 1.16-4.06 1.16-3.13 0-5.78-2.11-6.73-4.96H1.29v3.1A11.99 11.99 0 0 0 12 24z"
                            />
                            <path
                                fill="#FBBC05"
                                d="M5.27 14.29a7.19 7.19 0 0 1 0-4.58V6.61H1.29a11.99 11.99 0 0 0 0 10.78l3.98-3.1z"
                            />
                            <path
                                fill="#EA4335"
                                d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.43-3.43C17.95 1.19 15.24 0 12 0 7.29 0 3.25 2.72 1.29 6.61l3.98 3.1c.95-2.85 3.6-4.96 6.73-4.96z"
                            />
                        </svg>
