...
<body>
  ...
  <!-- HERO HEADER BANNER WITH STORE GRAPHICS -->
  <section class="shops-header-banner">
    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap">
      <div class="shops-banner-text text-end">
        <h1 class="page-header-title mb-1"><span class="brand-green">دليل</span> <span
            class="brand-white">المحلات</span> 🛍️</h1>
        <p class="page-header-sub">كل المحلات الموثوقة والمقارنة بينها في منطقتك</p>
      </div>
    ...
    <div class="container">
        ...
        <div class="row g-3 align-items-center">
          ...
          <div class="col-12 col-md-3">
            <div class="input-group">
              <input type="text" class="form-control border-1 rounded-3" placeholder="ابحث عن محل">
      ...
      <div class="row g-4 mb-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="shop-directory-card p-3 bg-white rounded-4 shadow-sm position-relative">
            <span class="badge bg-light text-success border border-success-subtle mb-2">الأرخص في المنطقة</span>
            <div class="d-flex justify-content-between align-items-start mb-3">
              <div>
                <h5 class="fw-bold mb-1">مول ابو دلال</h5>
                <div class="small text-muted">📍 النصيرات ·</div>
              </div>
              <img src="{{asset('assets/imges/logomall.jpg')}}" alt="محل" class="rounded-circle"
                style="width: 45px; height: 45px; object-fit: cover;">
            </div>
            <div class="d-flex gap-1 mb-3">
              <span class="badge bg-light text-dark">مواد غذائية</span>
              <span class="badge bg-light text-dark">خضراوات</span>
              <span class="badge bg-light text-dark">لحوم</span>
            </div>
            <a href="{{ route('shop-details') }}" class="btn-locate w-100 justify-content-center py-2">عرض الاسعار</a>
          </div>
        </div>
      ...
      <button class="btn-more mb-5">عرض المزيد من المحلات</button>
